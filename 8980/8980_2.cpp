...
// 0. 문제
// 마을의 개수, 트럭의 용량, 박스 정보(보내는 마을번호, 받는 마을번호, 박스 개수)가 주어질 때, 트럭 한 대로 배송할 수 있는 최대 박스 수
//
// 1. 정의
// 입력 : 마을의 개수, 트럭의 용량, 박스 정보(보내는 마을번호, 받는 마을번호, 박스 개수)
// 출력 : 배송 최대 총 박스 수?
//
// 2. 풀이
// 회의실 배정 문제와 마찬가지로 빨리 끝나는 배송순으로 선택
